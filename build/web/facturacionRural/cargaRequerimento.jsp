                ...
                <table class="table table-condensed table-bordered table-striped" id="tablaRequerimentos">
                    ...
                    <tbody>
                        <%
                            try {
                                con.conectar();
                                ResultSet rset = con.consulta("select r.F_IdReq, u.F_NomCli, DATE_FORMAT(r.F_FecEnt, '%d/%m/%Y') from tb_unireqrurales r, tb_uniatn u where r.F_ClaUni = u.F_ClaCli group by r.F_IdReq");
                                while (rset.next()) {
                        %>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form action="../FoliosRurales" method="post" class="col-sm-6">
                                    <input name="F_IdReq" class="hidden" value="<%=rset.getString(1)%>" />
                                    <button class="btn btn-sm btn-danger" name="accion" value="eliminaRequerimiento" onclick="return confirm('Seguro que desea eliminar el folio?')"><span class="glyphicon glyphicon-remove"></span></button>
                                </form>
                            </td>
                        </tr>
                        <%
