        ...
        <div class="container">
            ...
            <div class="row">
                <form action="../AbasteceModula" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <button class="btn btn-block btn-primary" name="accion" value="CargarAbasto" onclick="return confirm('Seguro de cargar el Abasto?')">Cargar Abasto</button>
                        </div>
                        <div class="col-sm-6">
                            <button class="btn btn-block btn-danger" name="accion" value="CancelarAbasto" onclick="return confirm('Seguro de CANCELAR el Abasto?')">Cancelar Abasto</button>
                        </div>
                    </div>
